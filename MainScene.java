...
public class MainScene extends Scene {
	...
	private void init(Stage primaryStage) {
		...
		Text copyrightText = new Text("Copyright © 2021 Fiek - All Rights Reserved");
		...
		primaryStage.setX((Screen.getPrimary().getVisualBounds().getWidth() - 1080) / 2);
		primaryStage.setY((Screen.getPrimary().getVisualBounds().getHeight() - 1000) / 2);
